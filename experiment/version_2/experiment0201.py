...
def main():
    ...
    dr.update_packet_in_seconds_by_packet_loss_rate(different_packet_loss_rate[1])
    ...
    dr.update_packet_in_seconds_by_packet_loss_rate(different_packet_loss_rate[2])
    ...
    dr.update_packet_in_seconds_by_packet_loss_rate(different_packet_loss_rate[3])
    ...
    dr.update_packet_in_seconds_by_packet_loss_rate(different_packet_loss_rate[4])
